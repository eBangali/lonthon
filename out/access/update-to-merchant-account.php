...
<div class='well'>
<h2 title='Update to Merchant Account'>Update to Merchant Account</h2>
</div>
...
/* MOU */
if (empty($_REQUEST["MOU"]))
{
$MOU_error = "<b class='text-warning'>MOU required</b>";
$error =1;
} 
/* Submition form */
if($error ==0)
...
$updateAccount .="<li>$MOU_error <input type='checkbox' name='MOU' /> <b>By sign up you agree our <a href='".outPagesLink."/mou.php'>MOU.</a></b></li>";
