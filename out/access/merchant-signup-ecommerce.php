...
<meta property='og:image:url' content='<?php echo themeResource; ?>/images/Advertisement-eCommerce.jpg' />
<meta property='og:image:type' content='image/jpeg' />
<meta property='og:image:width' content='1366' />
<meta property='og:image:height' content='768' />
<meta property='og:title' content='Sell Your Products Online! Upload Now!!' />
<meta property='og:description' content='Start An Online Store With Robust eCommerce Platform..  Everything You Need To Start Selling Online Today. Secure Shopping Cart · Fulfillment Integration · Accept Credit Cards · Social Media Integration' />
...
<meta name='twitter:title' content='Sell Your Products Online! Upload Now!!'/>
<meta name='twitter:description' content='Start An Online Store With Robust eCommerce Platform..  Everything You Need To Start Selling Online Today. Secure Shopping Cart · Fulfillment Integration · Accept Credit Cards · Social Media Integration'/>
<meta name='twitter:image' content='<?php echo themeResource; ?>/images/Advertisement.jpg'/>
<title>Sell Your Products Online! Upload Now!!</title>
<meta name='description' content='Start An Online Store With Robust eCommerce Platform..  Everything You Need To Start Selling Online Today. Secure Shopping Cart · Fulfillment Integration · Accept Credit Cards · Social Media Integration' />
...
<div class='well'>
<h1 title='Merchant Signup'>Merchant Signup</h1>
</div>
<div class='well'> 
...
$user->merchant_registration($username, $password, $email, $hash, $full_name, $code_mobile, $signup_date, $user_ip_address);
}
}
?>
<?php
...
<?php echo $aggreeTerms_error;  ?> <input type='checkbox' name='aggreeTerms' /> <b>By sign up you agree our <a href='<?php echo outPagesLink; ?>/terms-conditions.php'>terms and conditions.</a></b>
...
<input class='form-control' type='text' name='email' placeholder='username@gmail.com' required />>Username: <?php echo $username_error;  ?>
...
<?php } else { include_once (ebcontents.'/contents.php'); }?>