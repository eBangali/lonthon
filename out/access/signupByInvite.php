...
if (! preg_match('/^[a-z0-9._]+@[a-z0-9.\-]{1,16}[a-z]{2,4}$/',$email))
{
...
$user->registrationInvitedSignup($full_name, $code_mobile, $username, $password, $email, $emailhash, $signup_date, $user_ip_address, $countryNameWhenSignup);
}
}
?>
<?php
