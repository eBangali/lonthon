...
<?php } ?>
<?php if(!empty($contents_preview_link)){ ?>
<a class='eb-cart-back' href='<?php echo hypertextWithOrWithoutWww.$contents_preview_link; ?>'>Preview</a>
<?php } ?>
<?php if(!empty($contents_github_link)){ ?>
<a class='eb-cart-back' href='<?php echo hypertextWithOrWithoutWww.$contents_github_link; ?>'>Download</a>
<?php } endforeach; } ?>