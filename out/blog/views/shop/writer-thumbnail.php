...
$searchobj -> contents_thurmnail_group($articlewriter);
if($searchobj->data)
{
...
$newSearch .="<h2>".$searchobj->visulString($articlewriter)."</h2>";
$newSearch .="</div>";
$newSearch .="</li>";
$newSearch .="</ul>";
$newSearch .="</div>";
...
$newSearch .="<div class='item-img-info'><a class='product-image' title='".ucfirst($contents_og_image_title)."' href='";
