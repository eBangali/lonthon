...
#1. Can I apply for some trail work?
</a>
</h4>
</div>
<div id="collapse1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1">
<div class="panel-body">
Of course you can apply for the free trial, but before sending your product to be processed, please make sure you provide requirements and we will be happy to complete your <a href='<?php echo outPagesLink; ?>/contact.php'> FREE TRIAl. </a>
</div>
</div>
</div>
<div class="panel panel-default">
...
#2. Are there any limitations on the highest file size?
</a>
</h4>
</div>
...
<div class="panel-body">
Yes, we accept only .zip files. Please feel free to send us any file types such as .jpg, .tif, .psd, .eps but, you must compress files (zip files).
</div>
</div>
</div>
<div class="panel panel-default">
...
<div class="panel-body">
We are open 24/7/365 for smooth operation.
</div>
</div>
</div>
<div class="panel panel-default">
...
<div class="panel-body">
If you have any further queries, please feel free to <a href='<?php echo outPagesLink; ?>/contact.php'> Contact us </a>.
</div>
</div>
</div>
</div>
