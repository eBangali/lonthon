...
$mailReply->Subject = "Merchant replies to you";
//
$message ="<html>";
$message .="<head>";
$message .="<title>Merchant replies to you</title>";
$message .="<meta charset='utf-8'>";
$message .="<meta name='viewport' content='width=device-width, initial-scale=1'>";
$message .="<meta http-equiv='X-UA-Compatible' content='IE=edge' />";
$message .="<style type='text/css'>
...
//
$message .="<tr>";
$message .="<td>Hi $buyerUserNameToReply merchant replies to you</td>";
$message .="</tr>";
//
$message .="<tr bgcolor='#014693'>";
$message .="<td>";
$message .="<a href='";
$message .=outBayLink."/user-purchase-history.php";
