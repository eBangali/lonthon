...
if($width !==1366 )
{
echo("<pre>Image Width is $width Required Width 1366px.</pre>");
}
elseif($height !== 768)
{
echo("<pre>Image Height is $height Required Height 768px.</pre>");
}
...
elseif($height !== 768)
{
echo "<pre>Error: Image Height is $height Required Height 768px.</pre>";
}
/*** ***/
else 
{
